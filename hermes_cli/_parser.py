...
def _build_chat_parser(subparsers) -> argparse.ArgumentParser:
    ...
    add("--result-meta-fd", type=parse_result_metadata_fd, action=_StoreUnique,
        default=None, help="Write bounded terminal metadata to an inherited pipe FD (requires --query and classic CLI)")
