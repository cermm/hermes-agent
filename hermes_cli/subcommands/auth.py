...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_status.add_argument("provider", nargs="?", help="Optional provider id; omit for auth authority")
    auth_status.add_argument("--all-profiles", action="store_true", help="Show redacted authority for every profile")
