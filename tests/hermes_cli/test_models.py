...
class TestFetchOpenRouterModels:
    ...
    def test_live_fetch_recomputes_free_tags(self, monkeypatch):
        ...
        monkeypatch.setattr(_models_mod, "get_preferred_silent_default_model", lambda provider: None)
    ...
    def test_falls_back_to_remote_snapshot_on_live_fetch_failure(self, monkeypatch):
        remote_snapshot = [("remote/curated-model", "remote badge")]
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        with (
            patch(
